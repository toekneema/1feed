...
// Get last 5 YouTube video URLs using passed in channel ID
router.get("/:id", (req, res) => {
  ...
  axios
    .get(requestURL)
    .then((response) => {
      res.send(extractURLs(response.data.items));
    })
    .catch((e) => {
...
// Takes in an array of video items, and extracts the video ID of each of them and turns them into a full YouTube video URL
